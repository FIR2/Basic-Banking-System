...
<div id="container">
    ...
    <div class="container-large"
        style="color:orange; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#212529;">
        <div class="row">
            ...
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="finance.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
  
      <img src='' alt="abstbg2.png" style="width:100%; position:absolute; z-index:-1"> ;
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:orange;"><b>Our Awesome Facilities</b></h1>
